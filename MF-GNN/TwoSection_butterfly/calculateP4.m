function point = calculateP4(q)
global d;
q1=q(1); q2=q(2); q3=q(3); q4=q(4)/2; q5=q(5)/2; q6=q(6)/2;
...
%x = (sinphi1*sinphi2*(cos(kl2) - 1))/k2 - (cosphi1*(cos(kl1) - 1))/k1 + (cosphi1*sin(kl1)*sin(kl2))/k2 - (cosphi1*cosphi2*cos(kl1)*(cos(kl2) - 1))/k2;
%y = (sinphi1*sin(kl1)*sin(kl2))/k2 - (cosphi1*sinphi2*(cos(kl2) - 1))/k2 - (sinphi1*(cos(kl1) - 1))/k1 - (cosphi2*sinphi1*cos(kl1)*(cos(kl2) - 1))/k2;
%z = sin(kl1)/k1 + (cos(kl1)*sin(kl2))/k2 + (cosphi2*sin(kl1)*(cos(kl2) - 1))/k2;
