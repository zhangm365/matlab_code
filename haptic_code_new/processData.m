clear all;
close all;
% load data\JointAngle_ZNN.mat;
% load data\ObjectPosition_ZNN.mat;
load data\ObjectPosition_g1_d01_acf3_noise pa pd;
load data\JointAngle_g1_d01_acf3_noise joint_angle;
...
hold off;
axis equal;
legend('期望轨迹', '实际轨迹', 'best', 'fontsize', 18);
set(gca,'FontSize', 18);
...
set(gca,'FontSize',18);
xlim([0 (tail-start)*0.01]);
xlabel('时间 (s)', 'fontsize', 18,'interpreter','latex');
ylabel('关节角度 (rad)', 'fontsize', 18);
legend('关节 1', '关节 2', '关节 3','关节 4', '关节 5', '关节 6', 'fontsize', 18);
