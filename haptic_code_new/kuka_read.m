...
%         [res,simBase] = sim.simxGetObjectHandle(clientID, '/LBR_iiwa_7_R800', sim.simx_opmode_blocking );
        ...
        [res,p1]=sim.simxGetObjectPosition(clientID, simTip, -1, sim.simx_opmode_streaming );
        [res,p2]=sim.simxGetObjectPosition(clientID, simTarget, -1, sim.simx_opmode_streaming );
        % read joint angle:deg
        [res,r1angle]=sim.simxGetJointPosition(clientID,jointhandle1,sim.simx_opmode_streaming );
        [res,r2angle]=sim.simxGetJointPosition(clientID,jointhandle2,sim.simx_opmode_streaming );
        [res,r3angle]=sim.simxGetJointPosition(clientID,jointhandle3,sim.simx_opmode_streaming );
        [res,r4angle]=sim.simxGetJointPosition(clientID,jointhandle4,sim.simx_opmode_streaming );
        [res,r5angle]=sim.simxGetJointPosition(clientID,jointhandle5,sim.simx_opmode_streaming );
        [res,r6angle]=sim.simxGetJointPosition(clientID,jointhandle6,sim.simx_opmode_streaming );
        [res,r7angle]=sim.simxGetJointPosition(clientID,jointhandle7,sim.simx_opmode_streaming );
...
%             end  % stop after t = 1000 seconds
            ...
            % read position of tip and target
            [res,p1]=sim.simxGetObjectPosition(clientID, simTip, -1, sim.simx_opmode_buffer );   
            [res,p2]=sim.simxGetObjectPosition(clientID, simTarget, -1, sim.simx_opmode_buffer );
            ...
            % read joint angle:deg
            [res,r1angle]=sim.simxGetJointPosition(clientID,jointhandle1,sim.simx_opmode_buffer);   
            [res,r2angle]=sim.simxGetJointPosition(clientID,jointhandle2,sim.simx_opmode_buffer);
            [res,r3angle]=sim.simxGetJointPosition(clientID,jointhandle3,sim.simx_opmode_buffer);
            [res,r4angle]=sim.simxGetJointPosition(clientID,jointhandle4,sim.simx_opmode_buffer);
            [res,r5angle]=sim.simxGetJointPosition(clientID,jointhandle5,sim.simx_opmode_buffer);
            [res,r6angle]=sim.simxGetJointPosition(clientID,jointhandle6,sim.simx_opmode_buffer);
            [res,r7angle]=sim.simxGetJointPosition(clientID,jointhandle7,sim.simx_opmode_buffer); 
...
%         save data\ObjectPosition_ZNN pa pd;
%         save data\JointAngle_ZNN joint_angle;
        
        save data\ObjectPosition_g1_d01_acf3_noise pa pd;
        save data\JointAngle_g1_d01_acf3_noise joint_angle;
        
%         save data\JointVelocity_ZNN joint_velocity;
